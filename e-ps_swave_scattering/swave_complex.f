      !PROGRAM ELECTPS
!------------------------------------------
!---    HUMBERTSON POSITRON-HYDROGEN  -----
!------------------------------------------
!
!
!
!-----MODIFIED ON DECEMBER 1984 ELECTRON/POSITRONIUM
!-----SCATTERING
!
!-----Converted to Digital by William Mitchell (UNT) 11/2021
!
!-----THIS VERSION OF THE CODE WAS DERIVED FROM SWAVE_EXTEND.F AND
!-----COMPUTSE THE COMPLEX KOHN PHASE SHIFT VALUES ADDITIONALLY
!              
